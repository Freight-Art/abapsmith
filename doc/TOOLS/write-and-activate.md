...
`indentation=true style=keywordUpper keepIdentifier=true` (fixture 901) —
...
before the changed-bytes comparison (fixtures 902 and 903 were both
...
idempotent `changed: false` case (fixtures 902, 903), plus the
system-wide setting read (fixture 901). Still not verified live: the object
