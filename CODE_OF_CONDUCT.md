...
reported through GitHub's private security advisory feature on this
repository (Security tab → "Report a vulnerability") for issues that overlap
with security, or by direct contact with the maintainers:

artrayme@protonmail.com
