...
**Creatable and writable (16).** Everything else is not.
...
**Not reachable by any write (9).** Do not probe for a write route.

- Readable, not writable (3): `PROG/I` `FUGR/I` `XSLT/VT`
