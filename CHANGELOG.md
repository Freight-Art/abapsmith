...
- **`ABAP_AVAILABLE_MEMBERS_MAX`** (#146). Caps each candidate list in a `method=` `NOT_FOUND` (default 40, was a fixed 40); `availableTruncated` / `availableInheritedTruncated` report how many names were dropped.
